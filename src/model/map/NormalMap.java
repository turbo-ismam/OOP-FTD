...
public class NormalMap extends AbstractMapModel{
    ...
    void generatePath() {
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {     // da 5,10 a 15,10 da sopra a sotto
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {       // da 15,10 a 15,20 da sx a dx
