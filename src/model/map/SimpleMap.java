...
public class SimpleMap extends AbstractMapModel {
    ...
    void generatePath() {
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {     // da 5,0 a 5,10 da sx a dx
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {     // da 5,10 a 10,10 da sopra a sotto
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {     // da 10,10 a 10,5 da dx a sx
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {       // da 10,5 a 15,5 da sopra a sotto
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {      // da 15,5 a 15,15 da sx a dx
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {      // da 15,15 a 2,15 da sotto a sopra
        ...
        for (int i = 0; i < this.getGridSize() * this.getGridSize(); i++) {     // da 2,15 a 2,20 da sx a dx
